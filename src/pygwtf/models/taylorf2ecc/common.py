...
R = 1.5e11  # Astronomical unit [m]

f_m = 1/YRSID_SI # 1/ year

# Armlength of LISA in seconds
Armlength = 2.5e+9/clight
...
def _calculate_T(v, v0, e0, eta):
    ...
    '''
    term1 = (1 + ((743 / 252) + (11 / 3) * eta) * v**2 - (32 / 5) * pi * v**3 + 
    ...
    term2 = ((-10052469856691 / 23471078400) + 
         ...
         (15211 / 1728) * eta**2 + 
         (25565 / 1296) * eta**3 + 
         (3424 / 105) * log(16 * v**2)) * v**6
    
    term3 = ((-15419335 / 127008) - (75703 / 756) * eta + (14809 / 378) * eta**2) * pi * v**7

    term4 = -(157 / 43) * e0**2 * (v0 / v)**(19/3) * (1 + ((17592719 / 5855472) + (1103939 / 209124) * eta) * v**2 + \
        ((2833 / 1008) - (197 / 36) * eta) * v0**2 - (2819123 / 384336) * pi * v**3 + \
        (377 / 72) * pi * v0**3 + ((955157839 / 302766336) + (1419591809 / 88306848) * eta + \
        ...
        (18155 / 1296) * eta**2)*v0**4 -((166558393 / 12462660) + (679533343 / 28486080) * eta) * pi * v**5 + \
        (-(7986575459 / 387410688) + (555367231 / 13836096) * eta) * pi * v**3 * v0**2 + \
        ((6632455063 / 421593984) + (416185003 / 15056928) * eta) * pi * v**2 * v0**3 + \
        ((764881 / 90720) - (949457 / 22680) * eta) * pi * v0**5 +(-(2604595243207055311 / 16582316889600000) + (31576663 / 2472750) * gamma_e + \
        (924853159 / 40694400) * pi**2 + ((17598403624381 / 86141905920) - (886789 / 180864) * pi**2) * eta + \
        (203247603823 / 5127494400) * eta**2 + (2977215983 / 109874880) * eta**3 + \
        (226088539 / 7418250) * log(2) - (65964537 / 2198000) * log(3) + \
        (31576663 / 4945500) * (log(16) + log( v**2))) * v**6 + ((2705962157887 / 305188466688) + (14910082949515 / 534079816704) * eta - \
        (99638367319 / 2119364352) * eta**2 - (18107872201 / 227074752) * eta**3) * v**4 * v0**2 -(1062809371 / 27672192) * pi**2 * v**3 * v0**3 + \
        ...
        ((26531900578691 / 168991764480) - (3317 / 126) * gamma_e + (122833 / 10368) * pi**2 + \
         ((9155185261 / 548674560) - (3977 / 1152) * pi**2) * eta - (5732473 / 1306368) * eta**2 - \
         (3090307 / 139968) * eta**3 + (87419 / 1890) * log(2) - (26001 / 560) * log(3) - \
         (3317 / 252) * (log(16) + log(v0**2))) * v0**6)
...
def _Lambda_f_vec(v, v0, e0, eta):
    ...
    term5 = ((77096675/2032128) + (378515/12096) * eta - (74045/6048) * eta**2) * pi * v**7
    term6 = -(785/272) * e0**2 * (v0/v)**(19/3) * (
        ...
        + ((-3157483321/142430400) + (219563789/5086800) * eta) * pi * v**3 * v0**2
        + ((2622133397/159522048) + (164538257/5697216) * eta) * pi * v**2 * v0**3
        + ((764881/90720) - (949457/22680) * eta) * pi * v0**5
        + (
            (-204814565759250649/1061268280934400)
            + (12483797/791280) * gamma_e
            + (365639621/13022208) * pi**2
            + ((34787542048195/137827049472) - (8764775/1446912) * pi**2) * eta
...
def _Xi_ecc_term(theta, theta_0, eta):
    e_terms = 1 + (-7647061 / 70265664 + 209353 / 836496 * eta) * theta**2 + \
                (4445 / 3456 - 185 / 288 * eta) * theta_0**2 - \
                256883 / 3074688 * pi * theta**3 + 61 / 2880 * pi * theta_0**3 + \
                (-1172375466061 / 6586984406016 + 439689491 / 8477457408 * eta + \
                91590343 / 1867059072 * eta**2) * theta**4 + \
                (1024948915 / 1170505728 - 1026871 / 6967296 * eta + \
                14971 / 165888 * eta**2) * theta_0**4
    cross_terms = (-4855883735 / 34691162112 + 495545305 / 1264781952 * eta - \
                    1046765 / 6511104 * eta**2) * theta**2 * theta_0**2
    pi_terms = (49653615200993 / 96325793464320 - \
                449103385817 / 1146735636480 * eta) * pi * theta**5 + \
                (-12410299 / 17418240 + 576391 / 1451520 * eta) * pi * theta_0**5 + \
                (-1141844935 / 10626121728 + 47523355 / 885510144 * eta) * \
                pi * theta**3 * theta_0**2 + \
                (-466470721 / 202365112320 + 12770533 / 2409108480 * eta) * \
                pi * theta**2 * theta_0**3
    eta_terms = (-744458420948735 / 3252088301027328 + \
                    12376149277895 / 68362216538112 * eta + \
                    896664159665 / 30111928713216 * eta**2 - \
                    457951715 / 14532784128 * eta**3) * theta**4 * theta_0**2
    cross_pi2 = -15669863 / 8855101440 * pi**2 * theta**3 * theta_0**3
    high_order_eta = (-7837846874888815 / 82246362193723392 + \
                        76760406851419 / 326374453149696 * eta - \
                        60493466573 / 1295136718848 * eta**2 + \
                        3134223763 / 138764648448 * eta**3) * theta**2 * theta_0**4
    log_terms = (71857244107315089475141 / 32866417392257433600000 - \
                    75936937 / 158256000 * gamma_e - 9863961577 / 44275507200 * pi**2 + \
                    ...
                    75936937 / 158256000 * log(theta)) * theta**6 + \
                    (-55579234653596057 / 23361421521715200 + 15943/40320 * gamma_e + \
                    3968617/16588800 * pi**2 + (21736949245913/1685528248320 -12751/24576 * pi**2)*eta - \
                    1742350567/4013162496*eta**2 + 4790953/143327232*eta**3 + 8453/7560*log(2) - \
                    26001/35840*log(3)+15943/40320*log(theta_0)
                    ) * theta_0**6
    
    return e_terms + cross_terms + pi_terms + eta_terms + cross_pi2 + high_order_eta + log_terms


@njit
def _Xi(theta, theta_0, e0, eta):
    term1 = 1 + (743 / 2688 + 11 / 32 * eta) * theta**2 - 3 / 10 * pi * theta**3 + \
               (1855099 / 14450688 + 56975 / 258048 * eta + 371 / 2048 * eta**2) * theta**4 + \
               (-7729 / 21504 + 13 / 256 * eta) * pi * theta**5

    term2 = (-720817631400877 / 288412611379200 + 107 / 280 * gamma_e + 53 / 200 * pi**2 + \
                (25302017977 / 4161798144 - 451 / 2048 * pi**2) * eta - \
                30913 / 1835008 * eta**2 + 235925 / 1769472 * eta**3 + \
                107 / 280 * log(2 * theta)) * theta**6

    term3 = (-188516689 / 433520640 - 97765 / 258048 * eta + 141769 / 1290240 * eta**2) * \
               pi * theta**7
...
def _dXi_dtheta(theta, theta_0, e0, eta, include_ecc_term):
    ...
    term1_dtheta = 2 * (743 / 2688 + 11 / 32 * eta) * theta - 3 / 10 * pi * 3 * theta**2 + \
                     4 * (1855099 / 14450688 + 56975 / 258048 * eta + 371 / 2048 * eta**2) * theta**3 + \
                        5 * (-7729 / 21504 + 13 / 256 * eta) * pi * theta**4
    
    term2_common = (-720817631400877 / 288412611379200 + 107 / 280 * gamma_e + 53 / 200 * pi**2 + \
                (25302017977 / 4161798144 - 451 / 2048 * pi**2) * eta - \
                30913 / 1835008 * eta**2 + 235925 / 1769472 * eta**3)

    term2_dtheta = (6*(term2_common + 107 / 280 * log(2 * theta)) + 107/280) * theta**5

    term3_dtheta = 7 * (-188516689 / 433520640 - 97765 / 258048 * eta + 141769 / 1290240 * eta**2) * \
            pi * theta**6

    if include_ecc_term:
        de_terms_dtheta = 2 * (-7647061 / 70265664 + 209353 / 836496 * eta) * theta - \
                        3 * 256883 / 3074688 * pi * theta**2 + 4 * (-1172375466061 / 6586984406016 + 439689491 / 8477457408 * eta + \
                    91590343 / 1867059072 * eta**2) * theta**3
        
        dcross_terms_dtheta = 2 * (-4855883735 / 34691162112 + 495545305 / 1264781952 * eta - \
                        1046765 / 6511104 * eta**2) * theta * theta_0**2

        dpi_terms_dtheta = 5 * (49653615200993 / 96325793464320 - \
                    449103385817 / 1146735636480 * eta) * pi * theta**4 + \
                    3*(-1141844935 / 10626121728 + 47523355 / 885510144 * eta) * \
                    pi * theta**2 * theta_0**2 + \
                    2*(-466470721 / 202365112320 + 12770533 / 2409108480 * eta) * \
                    pi * theta * theta_0**3
        
        deta_terms_dtheta = 4 * (-744458420948735 / 3252088301027328 + \
                    12376149277895 / 68362216538112 * eta + \
                    896664159665 / 30111928713216 * eta**2 - \
                    457951715 / 14532784128 * eta**3) * theta**3 * theta_0**2

        dcross_pi2_dtheta = -15669863 / 8855101440 * pi**2 * 3 * theta**2 * theta_0**3

        dhigh_order_eta_dtheta = 2 * (-7837846874888815 / 82246362193723392 + \
                            76760406851419 / 326374453149696 * eta - \
                            60493466573 / 1295136718848 * eta**2 + \
                            3134223763 / 138764648448 * eta**3) * theta * theta_0**4

        log_terms_common = (71857244107315089475141 / 32866417392257433600000 - \
                    75936937 / 158256000 * gamma_e - 9863961577 / 44275507200 * pi**2 + \
                    (-672050112032567 / 87421728522240 + 1214953 / 3858432 * pi**2) * eta + \
                    380720733285643 / 1129197326745600 * eta**2 - \
                    231474834959 / 8065695191040 * eta**3 - \
        ...
        dlog_terms_dtheta = (6 * (log_terms_common - 75936937 / 158256000 * log(theta)) - 75936937 / 158256000) * theta**5

        d_eterm_part_dtheta = (de_terms_dtheta + dcross_terms_dtheta + dpi_terms_dtheta + deta_terms_dtheta + dcross_pi2_dtheta + dhigh_order_eta_dtheta + dlog_terms_dtheta)

        e_term_part = _Xi_ecc_term(theta, theta_0, eta)

        theta_ratio = (theta_0 / theta)**(19/3)
        dtheta_ratio_dtheta = -19/3 * theta_ratio / theta
        deccentricity_term_dtheta = -471 / 344 * e0**2 * (dtheta_ratio_dtheta * e_term_part + theta_ratio * d_eterm_part_dtheta)

    else:
        deccentricity_term_dtheta = 0

    return term1_dtheta + term2_dtheta + term3_dtheta + deccentricity_term_dtheta
...
def _d_foft_dt(t, tc, e0, M, eta, include_ecc_term=False):
    ...
    # Final derivative
    d_foft_dt = d_prefactor_dt * Xi / (pi * M) + (1 / 8 / tau**(3/8)) * dXi_dt / (pi * M)
...
def _get_phi_f_fdot(t, tc, parameters):
    ...
    phi0 = 2*(phi_coal - 1/(32 * v**5 * eta)* _Lambda_f_vec(v, v0, e0, eta))
...
@njit
def _get_time_to_coalescence(parameters):
    M = parameters[0]
    eta = parameters[1]
    e0 = parameters[3]
    f0 = parameters[5]
